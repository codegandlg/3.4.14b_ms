...
// for WPS ---------------------------------------------------->>
 ...
 if(!i18nLanguage) {
 	...
 	var charSize = $.inArray(i18nLanguage, webLanguage);
 	if(charSize > -1) {
 		document.cookie = 'userLanguage=' + i18nLanguage + ';expires=30';
 	} else {
 		i18nLanguage = 'en';
 		document.cookie = 'userLanguage=' + i18nLanguage + ';expires=30';
 	}
 ...
 if(i18nLanguage=='en'){
	...
	dmz_checkip3 = 'range in 1st digit. It should be 1-223.';
	dmz_checkip4 = 'range in 1st digit. It should not be 127.';
	dmz_checkip5 = 'range in 2nd digit. It should be 0-255.';
	dmz_checkip6 = 'range in 3rd digit. It should be 0-255.';
	dmz_checkip7 = 'range in 4th digit. It should be 1-254.';
	util_gw_mask_empty = 'Subnet mask cannot be empty! ';
	util_gw_ip_format = 'It should be filled with four 3-digit numbers, i.e., xxx.xxx.xxx.xxx.';
	tcpip_lan_invalid_dhcp_value = 'Invalid DHCP value!';
	tcpip_lan_invalid_ip_value = 'Invalid IP-address value!';
	tcpip_lan_invalid_subnet_value = 'Invalid subnet-mask value!';
	tcpip_lan_invalid_defgw_value = 'Invalid default-gateway value!';
	tcpip_lan_invalid_dhcpstart = 'Invalid DHCP client start address!';
	tcpip_lan_invalid_dhcpend = 'Invalid DHCP client end address!';
	tcpip_lan_invalid_dhcprange = 'Invalid DHCP client range!';
	tcpip_lan_invalid_dns_value = 'Invalid DNS address value!';
	...
	dmz_checkip3 = '范围在第一个字节中. 它必须在1-223之间.';
	dmz_checkip4 = '范围在第一个字节中. 它不能为127.';
	dmz_checkip5 = '范围在第二个字节中. 它必须在0-255之间.';
	dmz_checkip6 = '范围在第三个字节中. 它必须在0-255之间.';
	dmz_checkip7 = '范围在第四个字节中. 它必须在1-254之间.';
	util_gw_mask_empty = '子网掩码不能为空! ';
	util_gw_ip_format = '必须填充为4个数字，如 xxx.xxx.xxx.xxx.';
	tcpip_lan_invalid_dhcp_value = '无效的DHCP值!';
	tcpip_lan_invalid_ip_value = '无效的IP地址值!';
	tcpip_lan_invalid_subnet_value = '无效的子网掩码值!';
	tcpip_lan_invalid_defgw_value ='无效的默认网关值!';
	tcpip_lan_invalid_dhcpstart = '无效的DHCP客户端起始地址!';
	tcpip_lan_invalid_dhcpend = '无效的DHCP客户端结束地址!';
	tcpip_lan_invalid_dhcprange ='无效的DHCP客户端范围!';
	tcpip_lan_invalid_dns_value = '无效的DNS地址值!';
